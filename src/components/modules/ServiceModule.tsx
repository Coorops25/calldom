...
import { ArrowLeft, CheckCircle, Zap, Headphones, Globe } from 'lucide-react';
...
const servicesData: Record<string, ServiceData> = {
  '01': {
    ...
    desc: 'Agiliza tus comunicaciones, automatiza procesos y brinda respuestas instantáneas.',
  ...
  '02': {
    ...
    desc: 'Gestionamos y optimizamos tus operaciones con talento bilingüe de primer nivel.',
  ...
  '03': {
    id: '03',
    title: 'Omnicanalidad',
    desc: 'Unifica todos tus canales de comunicación en una sola plataforma.',
