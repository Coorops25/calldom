    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-8 right-8 z-[9500] flex flex-col items-end gap-3"
        >
          ...
          {WA_NUMBER && (
            <motion.a
              ...
              className="flex items-center gap-2.5 font-mono text-[0.55rem] tracking-[0.2em] uppercase px-5 py-3 bg-[#25D366] text-white shadow-[0_8px_32px_rgba(37,211,102,0.3)] hover:shadow-[0_12px_44px_rgba(37,211,102,0.45)] hover:-translate-y-0.5 transition-all duration-300"
            >
